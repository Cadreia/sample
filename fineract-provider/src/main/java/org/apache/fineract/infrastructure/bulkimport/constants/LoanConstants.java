...
public final class LoanConstants {
    ...
    public static final int CHARGE_AMOUNT_TYPE_1 = 38;// AM
    public static final int CHARGE_DUE_DATE_1 = 39;// AN
    public static final int CHARGE_NAME_2 = 40;// AO
    public static final int CHARGE_AMOUNT_2 = 41;// AP
    public static final int CHARGE_AMOUNT_TYPE_2 = 42;// AQ
    public static final int CHARGE_DUE_DATE_2 = 43;// AR
    public static final int GROUP_ID = 44;// AS
    public static final int LOOKUP_CLIENT_NAME_COL = 45;// AT
    public static final int LOOKUP_CLIENT_EXTERNAL_ID = 46;// AU
    public static final int LOOKUP_ACTIVATION_DATE_COL = 47;// AV
    public static final int LINK_ACCOUNT_ID = 48;// AW
    public static final int LOAN_ID_CLOSE_COL = 49;// AX
